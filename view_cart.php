...
<html>
    ...
    <body>
        ...
        <div class='container mt-3'>
			<div class='row'>
				<div class='col-md-12'>
					<h2 class='text-muted mb-4'>Itens do carrinho</h2>
					...
					<table class='table table-striped table-bordered'>
						...
						<?php foreach($items as $item): ?>
							<tr>
								...
								<td><a href='remove.php?id=<?php echo $item["id"]; ?>' onclick="return confirm('Confirmar remoção?')">Remover</a></td>
							</tr>
						<?php endforeach; ?>
						</tbody>
						<tfoot>
							<tr>
								<td colspan='3'><a href='index.php' class="btn btn-success">Continuar comprando</a></td>
								<th>Total</th>
								<th>$<span id='total'><?php echo $cart->get_cart_total();?></span></th>
								<td><a href='checkout.php' class='btn btn-info'>Confirmar compra</a></td>
							</tr>
						</tfoot>
					</table>
					<?php else: ?>
